          ...
          <div className="space-y-4 ">
            <div>
              ...
              <p className="text-sm opacity-70">
                Join Chat-App and start your language leraning adventure!
              </p>
            </div>
            <div className="space-y-3">
              ...
              <div className="form-control w-full">
                ...
                <input type="text" placeholder="User Surname" className="input input-bordered w-full" value={signupData.fullName} 
              ...
              {/*EMAIL*/}
               <div className="form-control w-full">
                ...
                <input type="email" placeholder="User@gmail.com" className="input input-bordered w-full" value={signupData.email} 
